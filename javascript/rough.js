...
document.addEventListener("DOMContentLoaded", function () {
    ...
    // if (dropdown) dropdown.value = localStorage.getItem("lang") || "en";
});
...
//   }
  ...
  function googleTranslateElementInit() {
    new google.translate.TranslateElement(
      { pageLanguage: 'en', includedLanguages: 'en,hu', autoDisplay: false },
      'google_translate_element'
    );
  }
  ...
  document.addEventListener("DOMContentLoaded", () => {
    ...
    langSelect.addEventListener("change", function () {
      ...
      const langOption = Array.from(innerDoc.querySelectorAll(".goog-te-menu2-item span.text"))
        .find(el => el.innerText.includes(lang === "en" ? "English" : "Hungarian"));
